...
public class Network implements Cloneable, Serializable
{
    ...
    public void initClusters(String clustersFileName) throws IOException
    {
    	FileInputStream fstream = new FileInputStream(clustersFileName);
		...
		while ((line = br.readLine()) != null){
			if(j<nNodes){
				cluster[j] = Integer.parseInt(line);
				j++;
			}else{
				break;
			}
